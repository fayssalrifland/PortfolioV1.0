        ...
        <div className='container px-5 py-24 mx-auto'>
            <div className='flex flex-col text-center w-full mb-20'>
                ...
                <p data-aos='fade-up' data-aos-delay='400' className='lg:w-2/3 mx-auto leading-relaxed text-base'>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quo, omnis? Illo minus quo ad, dolore eaque molestiae inventore, placeat error fugit earum, molestias architecto odio adipisci quis eligendi nam explicabo.
                </p>
            </div>
