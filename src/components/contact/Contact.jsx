  ...
  return (
    <section id='contact' className='text-gray-600 body-font'>
        <div className='container mx-auto flex px-5 py-24 items-center justify-center flex-col'>
            <div data-aos="fade-up" data-aos-delay="300" className='text-center lg:2/3 w-full'>
                <h1 className='title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900'>Contact</h1>
                <p className='mb-8 leading-relaxed'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt laboriosam pariatur quo voluptatem voluptatibus sunt distinctio fugit deserunt autem animi repellendus, enim accusantium illo dicta aut illum adipisci deleniti porro?
                </p> 
